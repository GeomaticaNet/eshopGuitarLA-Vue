<script setup>
    ...
    // Para pasar del padre hacia el hijo se hace por medio de props
    // Para pasar del hijo hacia el padre se hace por medio del emit.

    // Con defineEmits se trae la función incrementar del padre "App"
